...
- [ ] T027 [P] 创建 Office HWND、STA 消息泵、SetParent 与 DPI 诊断探针到 `runtime-dotnet/tools/ScpCv.InteropProbe/ScpCv.InteropProbe.csproj` 和 `runtime-dotnet/tools/ScpCv.InteropProbe/Program.cs`
