...
from scp_cv.player.adapters.ppt_window_embedding import (
...
__all__ = [
    "SLIDESHOW_CLASS_NAMES", "EMBEDDED_SLIDESHOW_PROP",
    "close_embedded_slideshow_window", "configure_windowed_slideshow",
    "detach_slideshow_window", "embed_slideshow_window", "find_slideshow_hwnd",
    "hide_embedded_slideshow_window", "mark_embedded_slideshow_window",
    "read_embedded_slideshow_owner", "resize_slideshow_window",
    "show_embedded_slideshow_window", "snapshot_slideshow_hwnds",
    "unmark_embedded_slideshow_window",
]
