...
from scp_cv.apps.dashboard.legacy_scenario_views import (
    activate_scenario_view as activate_scenario_view,
    api_scenarios as api_scenarios,
    create_scenario_view as create_scenario_view,
    delete_scenario_view as delete_scenario_view,
    update_scenario_view as update_scenario_view,
)
