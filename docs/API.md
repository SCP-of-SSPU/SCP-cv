...
| `window1_fullscreen_to_window2` | bool | 窗口 1 是否跨窗口 1/2 显示区域，启用时窗口 2 隐藏 |
...
| `PATCH` | `/api/playback/window1-fullscreen/` | JSON: `enabled` | 切换窗口 1 填充窗口 2，启用时前端禁用窗口 2 操作 |
...
| `window1_fullscreen_to_window2` | bool | 激活预案时是否恢复窗口 1 填充窗口 2 状态 |
